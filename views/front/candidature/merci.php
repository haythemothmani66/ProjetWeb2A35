...
<body>
    <div class="thank-you-card">
        ...
        <div class="btn-group-vertical">
            <a href="index.php?espace=front&module=offreemploi&action=liste" class="btn btn-primary">
                Voir d'autres offres
            </a>
            <a href="index.php?espace=front&module=candidature&action=liste" class="btn btn-outline-primary">
                Mes candidatures
            </a>
        </div>
    </div>
