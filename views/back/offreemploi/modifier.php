                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" class="row g-3" novalidate id="offre-form">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" id="datelimite" name="datelimite" class="form-control<?= !empty($fieldErrors['datelimite']) ? ' field-error' : '' ?>" value="<?= htmlspecialchars((string) $offre['datelimite']) ?>">
