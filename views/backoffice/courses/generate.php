...
<head>
    ...
    <title>Backoffice | AI Course Generation</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-title h1 { font-size: 26px; font-weight: 700; color: #0b104a; display: flex; align-items: center; gap: 10px; }
        .page-title h1 i { color: #8b5cf6; }
        ...
        <div class="main-content">
            <div class="top-bar">
                <div class="page-title">
                    <h1><i class="fas fa-magic"></i> AI Course Generator</h1>
                </div>
