...
class QuizRepository {
    ...
    public function getQuizCountsByCourseId(): array
    {
        $stmt = $this->db->query("SELECT course_id, COUNT(*) AS quiz_count FROM quizzes GROUP BY course_id");
        ...
        foreach ($rows as $row) {
            ...
            $counts[$courseId] = (int) ($row['quiz_count'] ?? 0);
        }
