...
class HomeController extends Controller {
    ...
    public function register($id) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // Utiliser l'ID de l'utilisateur connecte, sinon null (FK SET NULL)
            $participation->id_user = !empty($_SESSION['user_id']) ? (int) $_SESSION['user_id'] : null;
