...
<form action="<?php echo BASE_URL; ?>/AdminCategorie/create" method="POST" id="categorieForm" class="needs-validation" novalidate>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?php echo isset($data['errors']['nom_categorie']) ? 'is-invalid' : ''; ?>" id="nom_categorie" name="nom_categorie" value="<?php echo htmlspecialchars($data['old']['nom_categorie'] ?? ''); ?>">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="description" name="description" rows="3"><?php echo htmlspecialchars($data['old']['description'] ?? ''); ?></textarea>
    </div>
    <div class="mb-3">
        <label class="form-label d-block">Couleur</label>
        <?php
        $selectedColor = $data['old']['couleur'] ?? '#1F5DB8';
    ...
    <div class="mb-3">
        ...
        <select class="form-select <?php echo isset($data['errors']['statut']) ? 'is-invalid' : ''; ?>" id="statut" name="statut">
            <option value="actif" <?php echo (($data['old']['statut'] ?? 'actif') === 'actif') ? 'selected' : ''; ?>>Actif</option>
            <option value="inactif" <?php echo (($data['old']['statut'] ?? '') === 'inactif') ? 'selected' : ''; ?>>Inactif</option>
        </select>
