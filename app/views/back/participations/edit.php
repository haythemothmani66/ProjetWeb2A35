...
<form action="<?php echo BASE_URL; ?>/AdminParticipation/edit/<?php echo (int) $data['participation']['id_participation']; ?>" method="POST" id="participationForm" class="needs-validation" novalidate>
    ...
    <div class="mb-3">
        ...
        <input type="email" autocomplete="email" inputmode="email" spellcheck="false" autocapitalize="none" maxlength="254" title="Ex. prenom-nom@gmail.com — domaine gmail.com uniquement"
            ...
            class="form-control mail-control-gmail <?php echo isset($data['errors']['email']) ? 'is-invalid' : ''; ?>" id="email" name="email" placeholder="nom-utilisateur@gmail.com" value="<?php echo htmlspecialchars($data['participation']['email']); ?>">
        <div class="form-text">Sans espace, uniquement <strong>@gmail.com</strong>.</div>
