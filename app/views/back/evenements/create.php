...
<form action="<?php echo BASE_URL; ?>/AdminEvenement/create" method="POST" id="evenementForm" class="needs-validation" novalidate>
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="date" class="form-control <?php echo isset($data['errors']['date_debut']) ? 'is-invalid' : ''; ?>" id="date_debut" name="date_debut" value="<?php echo htmlspecialchars($data['old']['date_debut'] ?? ''); ?>">
