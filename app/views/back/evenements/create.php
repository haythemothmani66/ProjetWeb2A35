...
<form action="<?php echo BASE_URL; ?>/AdminEvenement/create" method="POST" id="evenementForm" class="needs-validation" novalidate>
    ...
    <div class="mb-3">
        ...
        <div class="form-text">Google&nbsp;Drive&nbsp;: partagez le fichier en «&nbsp;Toute personne disposant du lien&nbsp;», puis collez le lien (le site convertit l’URL pour l’affichage).</div>
    </div>
