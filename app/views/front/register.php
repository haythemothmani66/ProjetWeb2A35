        ...
        <div class="card shadow-sm border-0 p-4">
            ...
            <form action="<?php echo BASE_URL; ?>/Home/register/<?php echo (int) $data['evenement']['id_evenement']; ?>" method="POST" id="registerForm" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" autocomplete="email" inputmode="email" spellcheck="false" autocapitalize="none" maxlength="254" title="Ex. prenom-nom@gmail.com — domaine gmail.com uniquement"
                        pattern="[a-zA-Z0-9]+([._-][a-zA-Z0-9]+)*@gmail\.com"
                        class="form-control mail-control-gmail <?php echo isset($data['errors']['email']) ? 'is-invalid' : ''; ?>" id="email" name="email" placeholder="nom-utilisateur@gmail.com" value="<?php echo htmlspecialchars($data['old']['email'] ?? ''); ?>">
                    <div class="form-text">Saisie sans espace. Uniquement <strong>@gmail.com</strong> (lettres, chiffres, <code>.</code> <code>_</code> <code>-</code>).</div>
