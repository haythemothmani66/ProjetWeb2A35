...
<html lang="en">
  <head>
    ...
    <title>Mot de passe oublié | EduMatch</title>
  ...
  <body>
    ...
    <section class="auth-section">
      <div class="container">
        <div class="auth-card">
          <h2 class="text-center"><i class="fas fa-lock me-2"></i>Mot de passe oublié</h2>
          <p class="text-muted text-center mb-4">Entrez votre email pour recevoir un code de vérification</p>
          ...
          <form id="formForgot" action="/gestion_users/auth/doForgotPassword" method="POST">
            <div class="mb-4">
              <label class="form-label fw-semibold">Adresse email</label>
              <input type="text" class="form-control" id="forgotEmail" name="email" placeholder="exemple@email.com">
              <div class="text-danger small mt-1" id="err-email"></div>
            </div>
            <button type="submit" class="btn btn-primary"><i class="fas fa-paper-plane me-2"></i>Envoyer le code</button>
          </form>
          <p class="text-center mt-4 mb-0"><a href="sign-in.php" class="text-decoration-none"><i class="fas fa-arrow-left me-1"></i>Retour à la connexion</a></p>
        </div>
      </div>
    </section>
