        ...
        <div class="row">
          ...
          <div class="col-20 d-none d-xl-block text-end align-self-center">
            <div class="header-group">
              <span class="header-btn"><?= htmlspecialchars($_SESSION['user_nom'] ?? '') ?></span>
              <a href="/gestion_users/auth/logout" class="btn_one">Deconnexion</a>
              <?php if (($_SESSION['user_role'] ?? '') === 'admin'): ?>
              <a href="/gestion_users/view/backoffice/src/pages/backoffice/users.php" class="btn-backoffice">
                <i class="fas fa-tachometer-alt"></i> Backoffice
              </a>
              <?php endif; ?>
            </div>
          </div>
                ...
                <form id="formChangePwd" action="/gestion_users/profil/changePassword" method="POST">
                  <div class="mb-3">
                    ...
                    <div class="position-relative">
                      <input type="password" name="current_password" id="currentPwd" class="form-control pe-5">
                  ...
                  <div class="mb-4">
                    ...
                    <div class="position-relative">
                      <input type="password" name="confirm_password" id="confirmPwd" class="form-control pe-5" placeholder="Repeter">
