<div id="miniSidebar">
  ...
  <ul class="navbar-nav flex-column">
    ...
    <li class="nav-item">
      <div class="nav-heading">Devoirs</div>
      <hr class="mx-5 nav-line mb-1" />
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="/gestion_users/view/backoffice/src/pages/backoffice/submit_back.php">
        <span class="nav-icon"><i class="ti ti-edit"></i></span>
