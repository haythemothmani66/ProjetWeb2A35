...
<head>
    ...
    <title>Back Office - Nouveau Cours | EduMatch Admin</title>
    ...
    <style>
        .course-form-container { max-width: 600px; margin: 0 auto; background: white; padding: 40px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
        .course-form-container .form-group { margin-bottom: 25px; }
        .course-form-container label { display: block; margin-bottom: 8px; font-weight: 600; color: #1e293b; font-size: 14px; }
        .course-form-container input[type="text"],
        .course-form-container input[type="email"],
        .course-form-container textarea,
        .course-form-container select { width: 100%; padding: 12px; border: 1px solid #e0e0e0; border-radius: 8px; font-family: inherit; font-size: 14px; transition: 0.3s; }
        .course-form-container input[type="text"]:focus,
        .course-form-container textarea:focus,
        .course-form-container select:focus { outline: none; border-color: #525fe1; box-shadow: 0 0 0 3px rgba(82, 95, 225, 0.1); }
        .course-form-container textarea { resize: vertical; min-height: 120px; }
        .course-form-container .form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 15px; }
        ...
        .course-form-container .btn { padding: 12px 24px; border-radius: 8px; border: none; font-weight: 600; cursor: pointer; transition: 0.3s; font-size: 14px; text-decoration: none; display: inline-block; text-align: center; }
        .course-form-container .btn-primary { background: #525fe1; color: white; }
        .course-form-container .btn-primary:hover { background: #3d4bc7; color: white; }
        .course-form-container .btn-secondary { background: #f0f4ff; color: #525fe1; border: 1px solid #525fe1; }
        .course-form-container .btn-secondary:hover { background: #e3f2fd; }
        .error-message { color: #ef4444; font-size: 13px; margin-top: 8px; display: none; }
        .invalid { border-color: #ef4444 !important; }
        @media (max-width: 600px) { .course-form-container .form-row { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
    <div>
            ...
            <div class="custom-container">
                ...
                <div class="row mb-6 g-6 align-items-end">
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <a href="<?= htmlspecialchars(backofficeRoute('courses', 'index')); ?>" class="btn btn-outline-secondary">
