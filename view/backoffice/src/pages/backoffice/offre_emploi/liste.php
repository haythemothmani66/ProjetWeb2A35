        ...
        <div class="emploi-main">
            <header class="emploi-topbar px-4 py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a class="btn btn-outline-secondary" href="/gestion_users/controller/OffreEmploiController.php?espace=front&action=liste">Voir le front office</a>
                    <a class="btn btn-primary" href="/gestion_users/controller/OffreEmploiController.php?espace=back&action=ajouter">Nouvelle offre</a>
                </div>
            </header>
                            ...
                            <div class="card filter-card h-100">
                                <div class="card-body p-4">
                                    ...
                                    <select id="sort_by" name="sort_by" class="form-select mb-3">
                                        ...
                                        <option value="type_contrat" <?= $selectedSortBy === 'type_contrat' ? 'selected' : '' ?>>typecontrat</option>
                                        <option value="salairemin" <?= $selectedSortBy === 'salaire_min' ? 'selected' : '' ?>>salairemin</option>
                                        <option value="salairemax" <?= $selectedSortBy === 'salaire_max' ? 'selected' : '' ?>>salairemax</option>
                                        <option value="datecreation" <?= $selectedSortBy === 'date_creation' ? 'selected' : '' ?>>datecreation</option>
                                        <option value="datelimite" <?= $selectedSortBy === 'date_limite' ? 'selected' : '' ?>>datelimite</option>
                                        ...
                                        <?php foreach ($offres as $offre): ?>
                                            <tr class="offre-row">
                                                ...
                                                <td class="d-flex gap-2">
                                                    <a class="btn btn-sm btn-outline-warning" href="/gestion_users/controller/CandidatureController.php?espace=back&action=parOffre&id=<?= (int) $offre['id'] ?>">Candidatures</a>
                                                    <a class="btn btn-sm btn-outline-primary" href="/gestion_users/controller/OffreEmploiController.php?espace=back&action=details&id=<?= (int) $offre['id'] ?>">Details</a>
                                                    <a class="btn btn-sm btn-outline-secondary" href="/gestion_users/controller/OffreEmploiController.php?espace=back&action=modifier&id=<?= (int) $offre['id'] ?>">Modifier</a>
                                                    <a class="btn btn-sm btn-outline-danger" href="/gestion_users/controller/OffreEmploiController.php?espace=back&action=supprimer&id=<?= (int) $offre['id'] ?>" onclick="return confirm('Supprimer cette offre ?');">Supprimer</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
