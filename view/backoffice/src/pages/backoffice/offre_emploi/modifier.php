        ...
        <div class="emploi-main">
            <header class="emploi-topbar px-4 py-3 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h1 class="h4 mb-0">Modifier l'offre</h1>
                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" class="row g-3" novalidate id="offre-form">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" id="datelimite" name="datelimite" class="form-control<?= !empty($fieldErrors['date_limite']) ? ' field-error' : '' ?>" value="<?= htmlspecialchars((string) $offre['date_limite']) ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" id="salairemin" name="salairemin" class="form-control<?= !empty($fieldErrors['salaire_min']) ? ' field-error' : '' ?>" value="<?= htmlspecialchars((string) ($offre['salaire_min'] ?? '')) ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" id="salairemax" name="salairemax" class="form-control<?= !empty($fieldErrors['salaire_max']) ? ' field-error' : '' ?>" value="<?= htmlspecialchars((string) ($offre['salaire_max'] ?? '')) ?>">
