...
class Devoirs
{
    ...
    public function submit()
    {
        ...
        $successMessage = 'Votre devoir a été ajouté avec succès.';
        include __DIR__ . '/../view/template/submit.php';
        exit;
    }
    ...
    public function correct()
    {
        ...
        header('Location: /eduleb/controller/gestion devoirs/feed.php');
        exit;
    }
}
?>